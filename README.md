...
├── losses/
│   └── focal_loss.py      # FocalLoss ([torchvision.ops.sigmoid_focal_loss](https://docs.pytorch.org/vision/main/generated/torchvision.ops.sigmoid_focal_loss.html) ベース。one-hotターゲットに対しクラスごとに独立した2値分類として計算するマルチラベル的な定式化) と、クラスごとの有効サンプル数に基づく重み compute_class_balanced_alpha (Cui et al., 2019)
└── models/
